...
namespace Engine.Factories
{
    internal class WorldFactory
    {
        ...
        { 
            ...
            newWorld.AddLocation(-2, -1, "Farmer's Field", "There are rows of corn growing here, with giant rats hiding between " +
                "them.", "pack://application:,,,/Engine;component/Images/Locations/FarmFields.png");
            ...
            newWorld.AddLocation(-1, 0, "Trading Shop", "The shop of Susan, the trader.", "pack://application:,,,/Engine;component/Images/Locations/Trader.png");
            newWorld.AddLocation(0, 0, "Town Square", "You see a fountain here.", "pack://application:,,,/Engine;component/Images/Locations/TownSquare.png");
